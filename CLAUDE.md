...
יש דיון תכנוני נפרד (עדיין לא בנייה בפועל) על הפיכת הבוט הזה למוצר שנמכר
לעסקי סוכנויות דרכונים אחרים - מודל עסקי, ארכיטקטורת multi-tenant, שכבת
אחסון/אבטחה, מאגר מכונות VPS/RDP להרצת הדפדפן, טיפול בתקלות ושכבות
self-service. **כל התכנון המלא נמצא ב-`PLATFORM_PLAN.md`** באותה תיקייה -
לקרוא שם לפני שממשיכים בנושא הזה, לא כאן.
